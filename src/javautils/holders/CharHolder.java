...
/**
 * <p>A simple mutable holder for <code>char</code>-values. This class
 * is designed to be used in situations in which you need to store
 * chars in collections or when you want to be able to mutate an
 * char from an anonymous inner class, for example.</p>
 */
public class CharHolder extends AbstractHolder {
