...
/**
 * <p>A simple mutable holder for <code>long</code>-values. This class
 * is designed to be used in situations in which you need to store
 * longs in collections or when you want to be able to mutate an
 * long from an anonymous inner class, for example.</p>
 */
