...
/**
 * <p>A simple mutable holder for <code>short</code>-values. This class
 * is designed to be used in situations in which you need to store
 * shorts in collections or when you want to be able to mutate an
 * short from an anonymous inner class, for example.</p>
 */
public class ShortHolder extends AbstractHolder {
