...
/**
 * <p>A simple mutable holder for <code>double</code>-values. This class
 * is designed to be used in situations in which you need to store
 * doubles in collections or when you want to be able to mutate an
 * double from an anonymous inner class, for example.</p>
 */
public class DoubleHolder extends AbstractHolder {
